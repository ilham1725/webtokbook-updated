...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 08, 2021 at 03:51 PM
...
--
DELIMITER $$
CREATE TRIGGER `kurangi_buku` AFTER INSERT ON `pembelian` FOR EACH ROW BEGIN
...
--
-- Triggers `tambah_stok_buku`
--
DELIMITER $$
CREATE TRIGGER `tambah_stok` AFTER INSERT ON `tambah_stok_buku` FOR EACH ROW BEGIN
