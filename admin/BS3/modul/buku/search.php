                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <div class="col-md-8">
                                     <h4 class="title text-left" style=""><a href="index.php?page=buku&item=frm" class="btn btn-primary">Tambah Buku</a></h4>
                                </div>
                                <div class="col-md-4">
                        ...
                        <?php
                            ...
                            $result = mysqli_query($kon, "SELECT * FROM buku  INNER JOIN kategori ON buku.id_kat = kategori.id_kat WHERE judul LIKE '%".$cari."%' OR nm_kat LIKE '%".$cari."%' OR penulis LIKE '%".$cari."%'");
                            $total = mysqli_num_rows($result);
                            $pages = ceil($total/$halaman);            
                            $no =$mulai+1;
                            $sql = "SELECT * FROM buku INNER JOIN kategori ON buku.id_kat = kategori.id_kat WHERE judul LIKE '%".$cari."%' OR nm_kat LIKE '%".$cari."%' OR penulis LIKE '%".$cari."%' LIMIT $mulai, $halaman";
                        ...
                        <?php } ?>
                                   ...
                                   <div class="text-center">
                                    <ul class="pagination">
                                        ...
                                        for($i=1;$i<=$pages;$i++) {
                                            if ($i != $page) {
                                                echo "<li class='page-item'><a class='page-link' href='?page=buku&item=search&halaman_cari=$i'>$i</a></li>";
                                            } else {
